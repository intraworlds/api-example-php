...
function getResponse()
{
    ...
    $.post(
        "ajax.php", params, function (response, status) {
            ...
            var code = objResponse['response']['responseCode'];
            responseWithoutTime = JSON.stringify(objResponse['response']);
            ...
            responseArea.prepend("Response took " + responseTime + " seconds.\n");
            textAreaAdjust(responseArea);
